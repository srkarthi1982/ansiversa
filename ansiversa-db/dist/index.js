...
__export(src_exports, {
  NewPlatformSchema: () => NewPlatformSchema,
  NewQuestionSchema: () => NewQuestionSchema,
  NewResultSchema: () => NewResultSchema,
  NewRoadmapSchema: () => NewRoadmapSchema,
  NewSubjectSchema: () => NewSubjectSchema,
  NewTopicSchema: () => NewTopicSchema,
  ...
  UpdatePlatformSchema: () => UpdatePlatformSchema,
  UpdateQuestionSchema: () => UpdateQuestionSchema,
  UpdateResultSchema: () => UpdateResultSchema,
  UpdateRoadmapSchema: () => UpdateRoadmapSchema,
  UpdateSubjectSchema: () => UpdateSubjectSchema,
  UpdateTopicSchema: () => UpdateTopicSchema,
  createAstroDbDriver: () => createAstroDbDriver,
  createPlatformsRepo: () => createPlatformsRepo,
  createQuestionsRepo: () => createQuestionsRepo,
  createQuizAdminRepo: () => createQuizAdminRepo,
  createResultsRepo: () => createResultsRepo,
  createRoadmapsRepo: () => createRoadmapsRepo,
  createSubjectsRepo: () => createSubjectsRepo,
  createTopicsRepo: () => createTopicsRepo,
  getNextNumericId: () => getNextNumericId,
  loadAstroDbConfig: () => loadAstroDbConfig,
...
var createAstroDbDriver = (options) => {
  ...
  const client = (0, import_web.createClient)({ url, authToken });
  return {
    client,
...
var LevelEnum = import_zod.z.enum(["E", "M", "D"]);
var PlatformRowSchema = import_zod.z.object({
  id: import_zod.z.union([import_zod.z.number(), import_zod.z.string()]),
  name: import_zod.z.string(),
  description: import_zod.z.union([import_zod.z.string(), import_zod.z.null()]).optional(),
  icon: import_zod.z.union([import_zod.z.string(), import_zod.z.null()]).optional(),
  type: import_zod.z.union([import_zod.z.string(), import_zod.z.null()]).optional(),
  qCount: import_zod.z.union([import_zod.z.number(), import_zod.z.string(), import_zod.z.null()]).optional(),
  isActive: import_zod.z.union([import_zod.z.boolean(), import_zod.z.number(), import_zod.z.string()]).optional()
});
var SubjectRowSchema = import_zod.z.object({
  id: import_zod.z.union([import_zod.z.number(), import_zod.z.string()]),
  platformId: import_zod.z.union([import_zod.z.number(), import_zod.z.string()]),
  name: import_zod.z.string(),
  isActive: import_zod.z.union([import_zod.z.boolean(), import_zod.z.number(), import_zod.z.string()]).optional(),
  qCount: import_zod.z.union([import_zod.z.number(), import_zod.z.string(), import_zod.z.null()]).optional()
});
var TopicRowSchema = import_zod.z.object({
  id: import_zod.z.union([import_zod.z.number(), import_zod.z.string()]),
  platformId: import_zod.z.union([import_zod.z.number(), import_zod.z.string()]),
  subjectId: import_zod.z.union([import_zod.z.number(), import_zod.z.string()]),
  name: import_zod.z.string(),
  isActive: import_zod.z.union([import_zod.z.boolean(), import_zod.z.number(), import_zod.z.string()]).optional(),
  qCount: import_zod.z.union([import_zod.z.number(), import_zod.z.string(), import_zod.z.null()]).optional()
});
var RoadmapRowSchema = import_zod.z.object({
  id: import_zod.z.union([import_zod.z.number(), import_zod.z.string()]),
  platformId: import_zod.z.union([import_zod.z.number(), import_zod.z.string()]),
  subjectId: import_zod.z.union([import_zod.z.number(), import_zod.z.string()]),
  topicId: import_zod.z.union([import_zod.z.number(), import_zod.z.string()]),
  name: import_zod.z.string(),
  isActive: import_zod.z.union([import_zod.z.boolean(), import_zod.z.number(), import_zod.z.string()]).optional(),
  qCount: import_zod.z.union([import_zod.z.number(), import_zod.z.string(), import_zod.z.null()]).optional()
});
var QuestionRowSchema = import_zod.z.object({
  id: import_zod.z.union([import_zod.z.number(), import_zod.z.string()]),
  platformId: import_zod.z.union([import_zod.z.number(), import_zod.z.string()]),
  subjectId: import_zod.z.union([import_zod.z.number(), import_zod.z.string(), import_zod.z.null()]).optional(),
  topicId: import_zod.z.union([import_zod.z.number(), import_zod.z.string(), import_zod.z.null()]).optional(),
  roadmapId: import_zod.z.union([import_zod.z.number(), import_zod.z.string(), import_zod.z.null()]).optional(),
  q: import_zod.z.string(),
  o: import_zod.z.unknown().optional(),
  a: import_zod.z.string(),
  e: import_zod.z.union([import_zod.z.string(), import_zod.z.null()]).optional(),
  l: import_zod.z.union([import_zod.z.string(), import_zod.z.null()]).optional(),
  isActive: import_zod.z.union([import_zod.z.boolean(), import_zod.z.number(), import_zod.z.string()]).optional()
});
var ResultRowSchema = import_zod.z.object({
  id: import_zod.z.union([import_zod.z.number(), import_zod.z.string()]),
  ...
  topicId: import_zod.z.union([import_zod.z.number(), import_zod.z.string(), import_zod.z.null()]).optional(),
  roadmapId: import_zod.z.union([import_zod.z.number(), import_zod.z.string(), import_zod.z.null()]).optional(),
  level: import_zod.z.union([import_zod.z.string(), import_zod.z.null()]).optional(),
  responses: import_zod.z.unknown().optional(),
  mark: import_zod.z.union([import_zod.z.number(), import_zod.z.string(), import_zod.z.null()]).optional(),
  createdAt: import_zod.z.union([import_zod.z.string(), import_zod.z.number(), import_zod.z.date()])
});
var PlatformSchema = import_zod.z.object({
  id: import_zod.z.number().int(),
  name: import_zod.z.string(),
  description: import_zod.z.string(),
  icon: import_zod.z.string(),
  type: import_zod.z.string().nullable(),
  qCount: import_zod.z.number().int(),
  isActive: import_zod.z.boolean()
});
var NewPlatformSchema = import_zod.z.object({
  name: import_zod.z.string().min(1),
  description: import_zod.z.string().optional().default(""),
  icon: import_zod.z.string().optional().default(""),
  type: import_zod.z.string().nullable().optional(),
  qCount: import_zod.z.number().int().nonnegative().default(0),
  isActive: import_zod.z.boolean().default(true)
});
var UpdatePlatformSchema = import_zod.z.object({
  name: import_zod.z.string().min(1).optional(),
  description: import_zod.z.string().optional(),
  icon: import_zod.z.string().optional(),
  type: import_zod.z.string().nullable().optional(),
  qCount: import_zod.z.number().int().nonnegative().optional(),
  isActive: import_zod.z.boolean().optional()
});
var SubjectSchema = import_zod.z.object({
  id: import_zod.z.number().int(),
  platformId: import_zod.z.number().int(),
  name: import_zod.z.string(),
  isActive: import_zod.z.boolean(),
  qCount: import_zod.z.number().int()
});
var NewSubjectSchema = import_zod.z.object({
  id: import_zod.z.number().int().nonnegative().optional(),
  platformId: import_zod.z.number().int().nonnegative(),
  name: import_zod.z.string().min(1),
  isActive: import_zod.z.boolean().default(true),
  qCount: import_zod.z.number().int().nonnegative().default(0)
});
var UpdateSubjectSchema = import_zod.z.object({
  platformId: import_zod.z.number().int().nonnegative().optional(),
  name: import_zod.z.string().min(1).optional(),
  isActive: import_zod.z.boolean().optional(),
  qCount: import_zod.z.number().int().nonnegative().optional()
});
var TopicSchema = import_zod.z.object({
  id: import_zod.z.number().int(),
  platformId: import_zod.z.number().int(),
  subjectId: import_zod.z.number().int(),
  name: import_zod.z.string(),
  isActive: import_zod.z.boolean(),
  qCount: import_zod.z.number().int()
});
var NewTopicSchema = import_zod.z.object({
  id: import_zod.z.number().int().nonnegative().optional(),
  platformId: import_zod.z.number().int().nonnegative(),
  subjectId: import_zod.z.number().int().nonnegative(),
  name: import_zod.z.string().min(1),
  isActive: import_zod.z.boolean().default(true),
  qCount: import_zod.z.number().int().nonnegative().default(0)
});
var UpdateTopicSchema = import_zod.z.object({
  platformId: import_zod.z.number().int().nonnegative().optional(),
  subjectId: import_zod.z.number().int().nonnegative().optional(),
  name: import_zod.z.string().min(1).optional(),
  isActive: import_zod.z.boolean().optional(),
  qCount: import_zod.z.number().int().nonnegative().optional()
});
var RoadmapSchema = import_zod.z.object({
  id: import_zod.z.number().int(),
  platformId: import_zod.z.number().int(),
  subjectId: import_zod.z.number().int(),
  topicId: import_zod.z.number().int(),
  name: import_zod.z.string(),
  isActive: import_zod.z.boolean(),
  qCount: import_zod.z.number().int()
});
var NewRoadmapSchema = import_zod.z.object({
  id: import_zod.z.number().int().nonnegative().optional(),
  platformId: import_zod.z.number().int().nonnegative(),
  subjectId: import_zod.z.number().int().nonnegative(),
  topicId: import_zod.z.number().int().nonnegative(),
  name: import_zod.z.string().min(1),
  isActive: import_zod.z.boolean().default(true),
  qCount: import_zod.z.number().int().nonnegative().default(0)
});
var UpdateRoadmapSchema = import_zod.z.object({
  platformId: import_zod.z.number().int().nonnegative().optional(),
  subjectId: import_zod.z.number().int().nonnegative().optional(),
  topicId: import_zod.z.number().int().nonnegative().optional(),
  name: import_zod.z.string().min(1).optional(),
  isActive: import_zod.z.boolean().optional(),
  qCount: import_zod.z.number().int().nonnegative().optional()
});
var QuestionSchema = import_zod.z.object({
  id: import_zod.z.number().int(),
  platformId: import_zod.z.number().int(),
  subjectId: import_zod.z.number().int().nullable(),
  topicId: import_zod.z.number().int().nullable(),
  roadmapId: import_zod.z.number().int().nullable(),
  question: import_zod.z.string(),
  options: import_zod.z.array(import_zod.z.string()),
  answer: import_zod.z.string(),
  explanation: import_zod.z.string().nullable(),
  level: LevelEnum,
  isActive: import_zod.z.boolean()
});
var NewQuestionSchema = import_zod.z.object({
  platformId: import_zod.z.number().int().nonnegative(),
  subjectId: import_zod.z.number().int().nonnegative().nullable().optional(),
  topicId: import_zod.z.number().int().nonnegative().nullable().optional(),
  roadmapId: import_zod.z.number().int().nonnegative().nullable().optional(),
  question: import_zod.z.string().min(1),
  options: import_zod.z.array(import_zod.z.string()).default([]),
  answer: import_zod.z.string().min(1),
  explanation: import_zod.z.string().nullable().optional(),
  level: LevelEnum,
  isActive: import_zod.z.boolean().default(true)
});
var UpdateQuestionSchema = import_zod.z.object({
  ...
  topicId: import_zod.z.number().int().nonnegative().nullable().optional(),
  roadmapId: import_zod.z.number().int().nonnegative().nullable().optional(),
  question: import_zod.z.string().min(1).optional(),
  options: import_zod.z.array(import_zod.z.string()).optional(),
  answer: import_zod.z.string().min(1).optional(),
  explanation: import_zod.z.string().nullable().optional(),
...
var ResultSchema = import_zod.z.object({
  ...
  roadmapId: import_zod.z.number().int().nullable(),
  level: LevelEnum,
  responses: import_zod.z.unknown(),
  mark: import_zod.z.number(),
  createdAt: import_zod.z.date()
});
var NewResultSchema = import_zod.z.object({
  ...
  level: LevelEnum,
  responses: import_zod.z.unknown().optional(),
  mark: import_zod.z.number().default(0)
});
var UpdateResultSchema = import_zod.z.object({
  ...
  level: LevelEnum.optional(),
  responses: import_zod.z.unknown().optional(),
  mark: import_zod.z.number().optional()
});
...
var AstroDbEnvSchema = import_zod2.z.object({
  ASTRO_DB_URL: import_zod2.z.string().url(),
  ASTRO_DB_AUTH_TOKEN: import_zod2.z.string().optional()
});
